...
This page serves as a summary of the concepts we learned about in R Studio. 
The following sections will get into on the many functions that are useful for scientific analysis when working with environmental data. 
